...
/*
 * This is the main component that could be attach to any actor to react to Events sent from the EventManager
 */
...
UCLASS(BlueprintType,ClassGroup=(Custom), meta=(BlueprintSpawnableComponent,DisableNativeTick))
class EVENTMANAGERSYSTEM_API UEventListenerComponent : public UActorComponent
{
	GENERATED_BODY()
